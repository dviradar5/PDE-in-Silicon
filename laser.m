%% ADD PULSE AND TIME DEPENDANCE  (UPDATED)
%% DOCUMENT
...
classdef laser
    ...
    properties
        ...
        n_medium;            % Refractive index used for E<->I conversion (scalar)
    ...
    methods
        function obj = laser(wl, pls_wd, pls_enr, bm_D, type, r, phi, z, w0, z0, n_medium, varargin)
            ...
            %   n_medium  refractive index for scaling (e.g. 1 for air, ~3.48 for Si @1550nm)
            %
        ...
        function E0 = computeE0FromEnergy(this)
            ...
            E0 = sqrt(2*I0/(this.n_medium*eps0*c0));              % [V/m]
        end
        ...
        function I = intensityProfileNormalized(this)
            % Normalized spatial intensity (peak = 1), Nr x Nz
            I = abs(this.profile).^2;
            I = I / max(I(:));
        end

        function I = intensityProfileBLDumped(this, zvec, alpha_base)
            ...
            zvec = zvec(:).'; % 1 x Nz
            I = abs(this.profile).^2 .* exp(-alpha_base * zvec);
